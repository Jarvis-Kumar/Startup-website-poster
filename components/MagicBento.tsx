...
export const BentoCard: React.FC<BentoCardProps> = ({
  ...
  }, [animateParticles, clearAllParticles, shouldDisable, enableTilt, enableMagnetism, clickEffect, glowColor]);
...
export const BentoGrid: React.FC<BentoGridProps> = ({
  ...
  useEffect(() => {
    ...
    spotlight.style.cssText = `
      position: fixed;
      width: ${spotlightRadius * 2.5}px;
      height: ${spotlightRadius * 2.5}px;
      border-radius: 50%;
      pointer-events: none;
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const isNear = e.clientX >= gridRect.left - buffer && 
                     e.clientX <= gridRect.right + buffer && 
                     e.clientY >= gridRect.top - buffer && 
                     e.clientY <= gridRect.bottom + buffer;
